...
export const createTime = (value: number, format: TimeFormat): TimeObject => {
  ...
  const time: TimeObject = {
    ...
    fromNow: () => {
      ...
      if (ms < 60_000) return `in ${Math.round(ms / 1000)} seconds`;
      if (ms < 3_600_000) return `in ${Math.round(ms / 60_000)} minutes`;
      if (ms < 86_400_000) return `in ${Math.round(ms / 3_600_000)} hours`;
      if (ms < 604_800_000) return `in ${Math.round(ms / 86_400_000)} days`;
      if (ms < 2_629_800_000) return `in ${Math.round(ms / 604_800_000)} weeks`;
      if (ms < 31_557_600_000)
        return `in ${Math.round(ms / 2_629_800_000)} months`;
      return `in ${Math.round(ms / 31_557_600_000)} years`;
    },
    ago: () => {
      const ms = -time.toMilliseconds();
      ...
      if (ms < 604_800_000) return `${Math.round(ms / 86_400_000)} days ago`;
      if (ms < 2_629_800_000)
        return `${Math.round(ms / 604_800_000)} weeks ago`;
      if (ms < 31_557_600_000)
        return `${Math.round(ms / 2_629_800_000)} months ago`;
      return `${Math.round(ms / 31_557_600_000)} years ago`;
    },
  };
