...
import type { UnblockedDbSchema } from '../../db/get-tables';
import type {
...
export interface AdapterConfig {
   ...
   *
   * For example, MongoDB uses `_id` while in Unblocked we use `id`.
   *
   *
   * @example
  ...
  customTransformInput?: (props: {
    ...
    model: string;
    /**
     * The schema of the user's Unblocked instance.
     */
    schema: UnblockedDbSchema;
    /**
     * The options of the user's Unblocked instance.
     */
   ...
   * - If `generateId` is `false` in the user's Unblocked config, then this option will be ignored.
...
export interface CustomAdapter {
  ...
  createSchema?: (props: {
    ...
    file?: string;
    /**
     * The tables from the user's Unblocked instance schema.
     */
    tables: UnblockedDbSchema;
